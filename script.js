...
function createCard(obj) {
  ...
  const bookCovers = ["#f27121", "#e94057", "#8a2387"];
  const pickCover =
    myLibrary.length % 3 === 0
      ? bookCovers[2]
      : myLibrary.length % 2 === 0
      ? bookCovers[1]
      : bookCovers[0];
